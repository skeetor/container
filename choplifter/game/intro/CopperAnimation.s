...
.Loop:
	...
	addq	#1,d6					; Another block is done
...
.Loop1:
	...
	; The flag is now fully done, we can continue
	; with the next sequence.

	;move.l	#0,VBIProc				; Disable the animation to keep
	;bra.s	.Done					; displaying the flag.

	; If the flag has been hidden again, we swtich to the first
	; sequence.
